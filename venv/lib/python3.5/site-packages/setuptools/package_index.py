...
class PackageIndex(Environment):
    ...
    def download(self, spec, tmpdir):
        ...
        an existing local filename, or a app/version requirement spec
        ...
        app/version requirement spec, this method returns the location of
    ...
    def gen_setup(self, filename, fragment, tmpdir):
        ...
        if len(dists) == 1:  # unambiguous ``#egg`` fragment
            ...
            raise DistutilsError(
                "Can't unambiguously interpret app/version identifier %r; "
