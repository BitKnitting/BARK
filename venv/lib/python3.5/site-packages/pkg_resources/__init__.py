...
class _SetuptoolsVersionMixin(object):
    ...
    def __iter__(self):
        ...
        warnings.warn(
            ...
            "bug with the setuptools app describing that need.",
            RuntimeWarning,
            stacklevel=1,
        )
...
class WorkingSet(object):
    ...
    def __contains__(self, dist):
        """True if `dist` is the active distribution for its app"""
        return self.by_key.get(dist.key) == dist

    def find(self, req):
        """Find a distribution matching requirement `req`

        If there is an active distribution for the requested app, this
        returns it as long as it meets the version requirement specified by
        `req`.  But, if there is an active distribution for the app and it
        does *not* meet the `req` requirement, ``VersionConflict`` is raised.
        If there is no active distribution for the requested app, ``None``
        is returned.
        """
    ...
    def add(self, dist, entry=None, insert=True, replace=False):
        ...
        `dist` is only added to the working set if it's for a app that
    ...
    def find_plugins(self, plugin_env, full_env=None, installer=None,
        ...
        only distributions that are in the app's "plugin directory" or
        ...
        # scan app names in alphabetic order
        ...
        for project_name in plugin_projects:
            ...
            for dist in plugin_env[project_name]:
                ...
                try:
                    ...
                    error_info[dist] = v
                    if fallback:
                        # try the next older version of app
                        continue
                    else:
                        # give up on this app, keep going
                        break
                    ...
                    # success, no need to try any more versions of this app
                    break
...
class Environment(object):
    ...
    def __getitem__(self, project_name):
        ...
        app's distributions use their app's name converted to all
    ...
    def best_match(self, req, working_set, installer=None):
        ...
        ``VersionConflict`` if an unsuitable version of the app is already
    ...
    def __iter__(self):
        """Yield the unique app names of the available distributions"""
...
def to_filename(name):
    """Convert a app or version name to its filename-escaped form
